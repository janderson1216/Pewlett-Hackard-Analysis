...
--create current_emp by joining retirement info and dept_emp
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
...
--creat sales retirment list
select emp_no, first_name, last_name, dept_name
into sales_retiree
from dept_info
where dept_info.dept_name = ('Sales')

--create list of retirees in sales and developemnt 
select emp_no, first_name, last_name, dept_name
into sales_dev_retiree
from dept_info
where (dept_info.dept_name = ('Sales')) 
Or (dept_info.dept_name = ('Development')) 
order by dept_info.dept_name